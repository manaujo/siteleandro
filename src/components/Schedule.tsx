...
import img from "../assets/ImgBlog4_2.png";

const Schedule: React.FC = () => {
  const handleScheduleClick = () => {
    const phoneNumber = "5562982117161";
    const message = encodeURIComponent(
      "Olá! Gostaria de agendar uma visita técnica com a Smart Clean."
    );
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-slate-700 mb-8 leading-relaxed">
                Precisa de um orçamento personalizado ou quer resolver um
                problema com seu ar-condicionado? Agende uma visita técnica e
                nossos especialistas irão até você para uma avaliação completa.
              </p>
              <button
